...
class Myupload {
    ...
    function testIfExists($field = 'userfile') {
	...
	function is_allowed_filetype($ignore_mime = FALSE)
	{
        ...
        //Pavol 25/12/2010
        if ($this->allowed_types[0] == 'all') return TRUE;
